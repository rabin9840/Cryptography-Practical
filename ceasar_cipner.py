...
input_text=input("Please enter the text to encrypt:")
encrypt_key=int(input("Please enter the key to encrypt:"))

print(encryption(input_text,encrypt_key))
...
decrypt_text=input("Please enter the text to decrypt:")
decrypt_key=int(input("Please enter the key to decrypt:"))

print(decryption(decrypt_text, decrypt_key))
